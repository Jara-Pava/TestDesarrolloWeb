<%@ Page Language="VB" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="GridView.aspx.vb" Inherits="TestDesarrolloWeb.GridViewModule" Title="GridView" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        ...
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="Status" CellStyle-HorizontalAlign="Center" Width="90">
                <DataItemTemplate>
                        <span class="status-column <%#If((CInt(Eval("[Status]"))) = 1, "active", "closed")%>"></span>
                </DataItemTemplate>
                <PropertiesComboBox>
                    <Items>
            ...
            <dx:GridViewDataColumn FieldName="Votes" Width="80">
                <DataItemTemplate>
                    <%#If((CInt(Eval("[Votes]")) <> 0), "<span class='votes-column'>" & Eval("[Votes]") & "</span>", "")%>
                </DataItemTemplate>
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName=" TestDesarrolloWeb.Model.Issue"
        TypeName=" TestDesarrolloWeb.Model.DataProvider"
        SelectMethod="GetIssues" InsertMethod="AddNewIssue" UpdateMethod="UpdateIssue"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ContactsDataSource" runat="server" DataObjectTypeName=" TestDesarrolloWeb.Model.Contact"
        TypeName=" TestDesarrolloWeb.Model.DataProvider"
