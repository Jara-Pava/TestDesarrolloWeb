...
<asp:Content ID="ContentModulo" ContentPlaceHolderID="Content" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnGridProyectosEndCallback(s, e) {
            ...
            if (s.cpMessageType && s.cpMessage) {
                ...
                if (s.cpMessageType === "success") {
                    ...
                    if (gridProyectos.IsEditing()) {
                        pendingSuccessMessage = successMsg;
                        gridProyectos.CancelEdit();
                    } else {
                        setTimeout(function () {
        ...
        function ConfirmarEliminacion() {
            if (currentDeleteIndex >= 0) {
                gridProyectos.PerformCallback('DELETE|' + currentDeleteIndex);
    ...
    <dx:ASPxGridView ID="gridProyectos" runat="server" KeyFieldName="ID_Proyecto" AutoGenerateColumns="False"
        ClientInstanceName="gridProyectos"
        OnDataBinding="gridProyectos_DataBinding"
        OnRowUpdating="gridProyectos_RowUpdating"
        ...
        <Templates>
            <EditForm>
                <dx:ASPxFormLayout runat="server" ID="FormLayoutProyecto" Width="100%" Paddings-Padding="0">
                                ...
                                <dx:LayoutItem Caption="Planta" ColumnSpan="1" Width="65%">
                                    ...
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxTextBox ID="txtProyecto" runat="server" Width="100%" ClientInstanceName="txtProyecto"
                                                Text='<%# Bind("NombreProyecto") %>' AutoResizeWithContainer="true" />
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
